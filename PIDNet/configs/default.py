...
_C.LOSS.LAMBDA_ADV = 0.001
_C.LOSS.LAMBDA_ADV_AUX = 0.001
_C.LOSS.LAMBDA_ADV_MAIN = 0.001
_C.LOSS.LAMBDA_ADV_LIST = [0.0002, 0.001]
...
_C.TRAIN.AUGMENTATION_TYPE = None
_C.TRAIN.AUG_PROB = 0.5

_C.TRAIN.DACS_MIX_PROB = 0.7
_C.TRAIN.DACS_CLASSMIX_FRAC = 0.5
_C.TRAIN.DACS_LOSS_WEIGHT = 0.1
_C.TRAIN.DACS_PSEUDO_THR = 0.968

_C.TRAIN.LAMBDA_ADV = 0.001

_C.TRAIN.LAMBDA_SEG2 = 0.01
_C.TRAIN.LAMBDA_ADV1 = 0.001
_C.TRAIN.LAMBDA_ADV2 = 0.0002
