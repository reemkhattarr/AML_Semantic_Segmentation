...
# Fallback: se InPlaceABN non è disponibile, usa SyncBatchNorm
try:
    from modules.bn import InPlaceABNSync as BatchNorm2d
except Exception:
    import torch.nn as nn

    class BatchNorm2d(nn.SyncBatchNorm):
        def __init__(self, num_features, activation='none', **kwargs):
            # ignoriamo 'activation' come parametro opzionale
